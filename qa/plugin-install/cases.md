...
| INS-011 | Claude managed-path ownership | Add V refuses symlinked/unowned managed paths; Remove V and erase remove only an exact verified owned renderer and preserve foreign paths | symlink target overwrite, custom file deletion, or silent partial cleanup |
