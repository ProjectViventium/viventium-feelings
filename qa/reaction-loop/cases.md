...
| RCT-023 | New install, exact weak legacy default, and custom reaction instruction | New and exact-legacy-default states use the magnitude-neutral owner wording; custom text remains exact | minimum-strength bias returns or fuzzy migration rewrites custom text |
