...
| Surface | Automatic state | Reactions | Dashboard | Status |
| --- | --- | --- | --- | --- |
| Claude Code CLI | Yes, through trusted hooks | Native isolated Claude appraisal | Local companion | Target |
| Claude Desktop Code, local/SSH | Yes, through trusted hooks | Native isolated Claude appraisal | Local companion | Target |
| Codex CLI | Yes, through trusted hooks | Native isolated Codex appraisal | Local companion | Target |
| Codex in ChatGPT desktop | Yes, through trusted hooks | Native isolated Codex appraisal | Local companion | Target |
...
Restart Claude Code or Codex after updating from `0.1.0`. An already-running `0.1.0` hook process
does not gain the `0.1.1` lock protocol until the host starts the updated plugin.
